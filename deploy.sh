...
if curl -s -k https://groow-api-db.destinpq.com//health > /dev/null; then
...
echo "   - API: https://groow-api-db.destinpq.com//health"
echo "   - Docs: https://groow-api-db.destinpq.com/api/docs"
echo ""
echo "3. Update frontend API configuration to use:"
echo "   https://groow-api-db.destinpq.com/"
echo ""

if ! curl -s https://groow-api-db.destinpq.com//health > /dev/null; then
