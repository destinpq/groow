/**
 * Real Backend API Tests - Coupons Module
 * Generated: 2025-11-15T08:34:54.475Z
 * Endpoints: 2
 */

describe('🎯 Coupons Module - Real Backend', () => {
  ...
  describe('GET Requests', () => {
    ...
    it('GET /coupons', () => {
      ...
      cy.request({
        ...
        // Log response
        cy.log(`GET /coupons: ${response.status}`);
    ...
    it('GET /coupons/stats', () => {
      ...
      cy.request({
        ...
        // Log response
        cy.log(`GET /coupons/stats: ${response.status}`);
