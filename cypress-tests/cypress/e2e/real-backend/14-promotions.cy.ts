/**
 * Real Backend API Tests - Promotions Module
 * Generated: 2025-11-15T08:34:54.484Z
 * Endpoints: 2
 */

describe('🎯 Promotions Module - Real Backend', () => {
  ...
  describe('GET Requests', () => {
    ...
    it('GET /promotions', () => {
      ...
      cy.request({
        ...
        // Log response
        cy.log(`GET /promotions: ${response.status}`);
    ...
    it('GET /promotions/stats', () => {
      ...
      cy.request({
        ...
        // Log response
        cy.log(`GET /promotions/stats: ${response.status}`);
