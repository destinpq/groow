  ...
  return (
    <div style={{ padding: 24, background: '#f0f2f5', minHeight: '100vh' }}>
      <div style={{ marginBottom: 24 }}>
        <Title level={3}>
          <LineOutlined style={{ color: '#1890ff' }} /> Size Guide
        </Title>
            ...
            <Row gutter={16}>
              ...
              <Col xs={24} md={12}>
                <Collapse defaultActiveKey={['1']} ghost>
                  <Panel header={<Text strong><LineOutlined /> Chest</Text>} key="1">
                    <Paragraph>
